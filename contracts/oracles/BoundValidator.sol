...
/**
 * @dev Updated from https://github.com/VenusProtocol/oracle/blob/develop/contracts/oracles/BoundValidator.sol
 ...
 */
contract BoundValidator is ProtocolOwner, BoundValidatorInterface {
  ...
  function validatePriceWithAnchorPrice(
    ...
    // console.log('validatePriceWithAnchorPrice, reportedPrice: %s, anchorPrice: %s', reportedPrice, anchorPrice);
